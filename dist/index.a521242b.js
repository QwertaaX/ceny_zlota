...
$.get("http://api.nbp.pl/api/cenyzlota/last/30/?format=json", "json").done(function(data) {
...
$(window).on("afterprint", function() {
    for(let id in (0, _autoDefault.default).instances)(0, _autoDefault.default).instances[id].resize();
});
